		...
		<section className="about">
			<span className="text">
				<div className={bio ? "about__bio about__scroll" : "about__bio"}>
					...
					<p>
						{" "}
						Tech enthusiast with a passion for developing innovative digital
						content focused on the user experience. Skilled leader with 15 years
						of experience and the proven ability to motivate, educate, and
						manage a team of professionals. Strategic thinker and adaptable
						creator to develop software that is customized to meet a company’s
						organizational needs, highlight their core values, and further their
						success.
					</p>

					<p>
						With skills in <strong>React</strong>, <strong>JavaScript</strong>,{" "}
						<strong>HTML</strong>, <strong>CSS</strong>, <strong>SASS</strong>,
						and <strong>MongoDB</strong>, among others. Confident
						problem-solving abilities to overcome glitches with creative
						solutions that are strategically designed to last long-term. Strong
						communication skills and the ability to acquire user feedback to
						determine modifications for optimal user experience.
					</p>
				</div>
				...
				<div
					className={
						link ? "social-icons social-icons__scroll" : "social-icons"
					}
				>
					<a href="https://www.linkedin.com/in/tryon-experiences">
						{" "}
						<i className="fab fa-linkedin fa-2x "></i>
					</a>
					<a href="https://github.com/banutryon?tab=repositories">
						{" "}
